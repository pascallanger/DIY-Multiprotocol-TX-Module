...
const uint8_t LOSI_bind_data_code[16] = { 0xD7, 0xA1, 0x54, 0xB1, 0x5E, 0x89, 0xAE, 0x86, 0xC9, 0x2C, 0x06, 0x93, 0x86, 0xB9, 0x9E, 0xD7 } ;
...
static void __attribute__((unused)) LOSI_cyrf_init()
{
	...
	CYRF_SetPower(0x38);									// 64 SDR mode
...
uint16_t LOSI_callback()
{
	...
	if(bind_counter)
	{
		...
		{
			BIND_DONE;
			CYRF_ConfigDataCode(LOSI_data_code[hopping_frequency[0] % 5], 16);			// Load normal data code
			packet_period = 19738;
		}
	}
	LOSI_send_packet();
...
void LOSI_init()
{
	...
	//	{ 0x5F, 0x30, 0x3B, 0x56, 0x96, 0x45, 0xF4, 0xA1, 0x03, 0xBC, 0x6E, 0x8A, 0xEF, 0xBD, 0xFE, 0xF8 }	//for channel 0x27
