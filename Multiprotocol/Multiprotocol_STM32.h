...
#define  SDI_on digitalHi(GPIOB,SDI_pin)			
#define  SDI_off digitallo(GPIOB,SDI_pin)		

#define  SDI_1 (digitalIn(GPIOB,SDI_pin)==HIGH)	
#define  SDI_0 (digitalIn(GPIOB,SDI_pin)==LOW)			

#define CC25_CSN_on digitalHi(GPIOB,CC25_CSN_pin)		
#define CC25_CSN_off digitallo(GPIOB,CC25_CSN_pin)	

#define NRF_CSN_on digitalHi(GPIOB,NRF_CSN_pin)		
#define NRF_CSN_off digitallo(GPIOB,NRF_CSN_pin)	

#define CYRF_CSN_on digitalHi(GPIOB,CYRF_CSN_pin)		
#define CYRF_CSN_off digitallo(GPIOB,CYRF_CSN_pin)	

#define  SDO_1 (digitalIn(GPIOB,SDO_pin)==HIGH)		
#define  SDO_0 (digitalIn(GPIOB,SDO_pin)==LOW)				
