...
1. In arduino IDE under the **Tools** -> **Board:** select the **Generic STM32F103C series** board.Select upload method serial **Serial**.Do not leave upload method on default **STM32duino bootloader**
